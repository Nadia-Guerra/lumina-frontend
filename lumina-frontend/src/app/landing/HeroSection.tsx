    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 flex items-center justify-between gap-8">
        ...
        <div className="flex flex-col gap-4 max-w-xs">
          <h1 className="font-black uppercase leading-tight" style={{ fontSize: 'clamp(2rem, 5vw, 3rem)' }}>
          ...
          <button
            id="hero-cta-btn"
            className="self-start bg-[#E8739A] hover:bg-[#d45f87] text-white px-6 py-2.5 rounded-full text-sm font-semibold transition-all active:scale-95 cursor-pointer shadow-md mt-2"
          >
            Comienza ahora
          </button>
        </div>
        ...
        {/* Right image */}
        <div className="relative w-[340px] h-[340px] flex-shrink-0 hidden md:block">
          <Image
